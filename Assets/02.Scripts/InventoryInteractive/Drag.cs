...
public class Drag : MonoBehaviour, IDragHandler, IBeginDragHandler, IEndDragHandler
{
    ...
    public static GameObject draggingObj;           // 현재 드래그 중인 아이템 오브젝트의 참조값이 들어갑니다.
    ...
    public void OnBeginDrag( PointerEventData eventData )
    {
        ...
        draggingObj=this.gameObject;                        // 드래그가 시작되면 드래그 중인 아이템 정보가 있어야 한다
    ...
    {
        draggingObj=null;                                   // 드래그 중인 아이템 정보를 null로 만든다.
