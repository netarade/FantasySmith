...
/// <summary>
/// 장비 제작 시뮬레이션을 담당하는 클래스입니다. 컴포넌트로 붙여 활용하며, 별도의 참조를 위한 인스턴스 생성이 필요하지 않습니다.<br/>
/// 스크립트 시작 타이밍은 캐릭터가 특정 지역, 공간에 갔을 때, 트리거 발동조건이 있는 후 순위 스크립트이며, 
/// 많은 외부 참조를 해야 하므로 씬전환 시 파괴가능한 오브젝트에 두는 것이 적합합니다.<br/> 
/// </summary>
