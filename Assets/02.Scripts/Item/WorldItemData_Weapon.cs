...
public partial class WorldItem
{
    ...
    {        
        ...
        {
            /*** 검 ***/
            { "철 검", new ItemCraftWeapon( ItemType.Weapon, WeaponType.Sword, "0001000", "철 검", 10.0f, new VisualReferenceIndex(0)
            ...
            { "강철 검", new ItemCraftWeapon( ItemType.Weapon, WeaponType.Sword, "0001001", "강철 검", 20.0f, new VisualReferenceIndex(1)
            ...
            { "미스릴 검", new ItemCraftWeapon( ItemType.Weapon, WeaponType.Sword, "0001002", "미스릴 검", 40.0f, new VisualReferenceIndex(2) 
            ...
            { "흑철 검", new ItemCraftWeapon( ItemType.Weapon, WeaponType.Sword, "0001003", "흑철 검", 60.0f, new VisualReferenceIndex(3) 
            ...
            { "프레첼", new ItemCraftWeapon( ItemType.Weapon, WeaponType.Sword, "0001004", "프레첼", 80.0f, new VisualReferenceIndex(4) 
            ...
            { "얼음칼날", new ItemCraftWeapon( ItemType.Weapon, WeaponType.Sword, "0001100", "얼음칼날", 120.0f, new VisualReferenceIndex(5)
            ...
            { "백은의 검", new ItemCraftWeapon( ItemType.Weapon, WeaponType.Sword, "0001101", "백은의 검", 180.0f, new VisualReferenceIndex(6)
            ...
            { "기사단의 검", new ItemCraftWeapon( ItemType.Weapon, WeaponType.Sword, "0001102", "기사단의 검", 150.0f, new VisualReferenceIndex(7)
            ...
            { "아밍 소드", new ItemCraftWeapon( ItemType.Weapon, WeaponType.Sword, "0001103", "아밍 소드", 110.0f, new VisualReferenceIndex(8) 
            ...
            { "하플랑", new ItemCraftWeapon( ItemType.Weapon, WeaponType.Sword, "0001104", "하플랑", 100.0f, new VisualReferenceIndex(9) 
            ...
            { "천공의 지배", new ItemCraftWeapon( ItemType.Weapon, WeaponType.Sword, "0001200", "천공의 지배", 680.0f, new VisualReferenceIndex(10)
            ...
            { "파멸의 불꽃", new ItemCraftWeapon( ItemType.Weapon, WeaponType.Sword, "0001201", "파멸의 불꽃", 640.0f, new VisualReferenceIndex(11)
            ...
            { "듀란달", new ItemCraftWeapon( ItemType.Weapon, WeaponType.Sword, "0001202", "듀란달", 480.0f, new VisualReferenceIndex(12) 
            ...
            { "미스틸테인", new ItemCraftWeapon( ItemType.Weapon, WeaponType.Sword, "0001203", "미스틸테인", 700.0f, new VisualReferenceIndex(13) 
            ...
            { "크시포스", new ItemCraftWeapon( ItemType.Weapon, WeaponType.Sword, "0001204", "크시포스", 350.0f, new VisualReferenceIndex(14) 
            ...
            /**** 활 ****/
            { "사냥꾼의 활", new ItemCraftWeapon( ItemType.Weapon, WeaponType.Bow, "0008000", "사냥꾼의 활", 10.0f, new VisualReferenceIndex(0)
                , ItemGrade.Low, 10, 100, 0.8f, 10, AttributeType.None
                , new CraftMaterial[]{new CraftMaterial("철",3), new CraftMaterial("단단한 나뭇가지",3)} 
                , null 
                , Recipie.Eu) 
            },
            { "롱 보우", new ItemCraftWeapon( ItemType.Weapon, WeaponType.Bow, "0008001", "롱 보우", 20.0f, new VisualReferenceIndex(1)
            ...
            { "컴뱃 보우", new ItemCraftWeapon( ItemType.Weapon, WeaponType.Bow, "0008002", "컴뱃 보우", 40.0f, new VisualReferenceIndex(2) 
            ...
            { "양치기의 활", new ItemCraftWeapon( ItemType.Weapon, WeaponType.Bow, "0008003", "양치기의 활", 60.0f, new VisualReferenceIndex(3) 
            ...
            { "도망자의 활", new ItemCraftWeapon( ItemType.Weapon, WeaponType.Bow, "0008004", "도망자의 활", 80.0f, new VisualReferenceIndex(4) 
            ...
            { "샤이닝 보우", new ItemCraftWeapon( ItemType.Weapon, WeaponType.Bow, "0008100", "샤이닝 보우", 120.0f, new VisualReferenceIndex(5)
            ...
            { "이글 보우", new ItemCraftWeapon( ItemType.Weapon, WeaponType.Bow, "0008101", "이글 보우", 180.0f, new VisualReferenceIndex(6)
            ...
            { "탄궁", new ItemCraftWeapon( ItemType.Weapon, WeaponType.Bow, "0008102", "탄궁", 150.0f, new VisualReferenceIndex(7) 
            ...
            { "각궁", new ItemCraftWeapon( ItemType.Weapon, WeaponType.Bow, "0008103", "각궁", 110.0f, new VisualReferenceIndex(8) 
            ...
            { "추격자의 활", new ItemCraftWeapon( ItemType.Weapon, WeaponType.Bow, "0008104", "추격자의 활", 100.0f, new VisualReferenceIndex(9) 
            ...
            { "취풍 파르티아", new ItemCraftWeapon( ItemType.Weapon, WeaponType.Bow, "0008200", "취풍 파르티아", 450.0f, new VisualReferenceIndex(10)
            ...
            { "피닉스의 속삭임", new ItemCraftWeapon( ItemType.Weapon, WeaponType.Bow, "0008201", "피닉스의 속삭임", 640.0f, new VisualReferenceIndex(11)
            ...
            { "태양의 활", new ItemCraftWeapon( ItemType.Weapon, WeaponType.Bow, "0008202", "태양의 활", 530.0f, new VisualReferenceIndex(12) 
            ...
            { "장미의 신궁", new ItemCraftWeapon( ItemType.Weapon, WeaponType.Bow, "0008203", "장미의 신궁", 480.0f, new VisualReferenceIndex(13) 
            ...
            { "파마의 활", new ItemCraftWeapon( ItemType.Weapon, WeaponType.Bow, "0008204", "파마의 활", 420.0f, new VisualReferenceIndex(14) 
            ...
            /**** 도끼 ****/
            { "손도끼", new ItemCraftWeapon( ItemType.Weapon, WeaponType.Axe, "0002000", "손도끼", 10.0f, new VisualReferenceIndex(0)
                , ItemGrade.Low, 10, 100, 0.8f, 10, AttributeType.None
                , new CraftMaterial[]{new CraftMaterial("철",3), new CraftMaterial("단단한 나뭇가지",3)} 
                , null 
                , Recipie.Na) 
